---
title: Go 语言中的零拷贝 splice 优化
date: 2021-06-06
params:
  author: Andy Pan
summary: 为 Go 语言内部的 splice 系统调用实现一个 pipe pool
tags:
 - 内存管理
 - Golang
 - 底层原理
...
![](https://res.strikefreedom.top/static_res/blog/figures/1_8bPiDNL1K1ZdK9O_T5IVKw.png)
...
![](https://res.strikefreedom.top/static_res/blog/figures/pipe-pool-in-haproxy.png)
...
![](https://res.strikefreedom.top/static_res/blog/figures/go-sync-pool.png)
