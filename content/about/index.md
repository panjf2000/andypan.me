...
I initially started my programming journey in college by pitching into `C`. Later on, I successively engaged in `Qt/C++`, `ASP.NET/C#`, `PHP/JS/HTML/CSS`, `Android/Java`, `Web/Python`, etc. I worked for some transnational corporations where I mostly wrote server-side code in C++/Java/Python/Go along with doing the designing backend and full-stack systems as a systems architect.
